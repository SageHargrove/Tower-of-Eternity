...
- Hero profile generation: ~$0.01 per hero (GPT-4o)
- Combat narration: ~$0.001 per floor (GPT-4o-mini)
- Portrait generation: ~$0.04 per portrait (DALL-E 3) — opt-in only
- Events: ~$0.001 per event (GPT-4o-mini)

For testing, portraits are off by default. You can test all other systems cheaply.
