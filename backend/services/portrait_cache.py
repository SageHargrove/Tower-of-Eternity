...
ENEMY_PORTRAIT_HINTS = {
    ...
    "Giant Rat": "a true RODENT, not a wolf or dog — a short blunt snout with twitching whiskers, small rounded ears, a plump compact rat-shaped body on short legs, a thin hairless ropey tail, matted brown-grey fur, small dark eyes glowing red, sharp yellowed incisors bared, crouched low to the ground, dim dungeon corridor background",
    ...
    "Goblin": "a small wiry goblin humanoid, (sickly green mottled skin, green clearly visible as the skin color:1.3), oversized pointed ears, a hooked nose, sharp yellowed teeth bared in a snarl, ragged dark leather scraps for clothing, gripping a crude rusted blade, crouched scrappy stance, beady yellow eyes, gritty dungeon background",
