...
ENEMY_PORTRAIT_HINTS = {
    ...
    "Giant Rat": "an oversized rat-like vermin creature, matted brown-grey fur, a rounded hunched body, a thin hairless tail, large torn ears, small dark eyes glowing red, sharp yellowed incisors bared, hunched low on all fours, dim dungeon corridor background",
    ...
    "Goblin": "a small wiry goblin humanoid, sickly green mottled skin, oversized pointed ears, a hooked nose, sharp yellowed teeth bared in a snarl, ragged dark leather scraps for clothing, gripping a crude rusted blade, crouched scrappy stance, beady yellow eyes, gritty dungeon background",
    ...
    "Wolf": "a lean wolf, dense grey and white fur, sharp pointed ears alert and forward, bared fangs in a snarl, glowing pale yellow eyes, muscular low predatory stance on all fours, bushy tail held low, snowy forest background",
    "Dire Wolf": "a massive dire wolf, larger and more savage than an ordinary wolf, shaggy grey fur, a scarred muzzle, oversized fangs bared, glowing amber eyes, thick powerful shoulders, low aggressive stance on all fours, dead forest background",
    "Orc": "a hulking orc warrior, green-grey mottled skin, a jutting lower jaw with prominent tusks, small dark eyes under a heavy brow, crude spiked iron armor plates strapped over leather, gripping a heavy cleaver-like blade, broad aggressive stance, war-camp background",
    "Ogre": "a massive lumbering ogre, warty greenish-brown skin, a heavy brutish jaw with jutting yellowed tusks, small dull eyes, a bloated muscular frame wrapped in crude furs and rusted armor scraps, gripping a crude wooden club studded with nails, hunched towering stance",
