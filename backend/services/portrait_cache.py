...
ENEMY_PORTRAIT_HINTS = {
    ...
    "Giant Rat": "an oversized RODENT — (explicitly NOT a wolf, NOT a dog, NOT canine in any way; a true rat: a rounded hunched back, a short blunt snout with twitching whiskers, small rounded ears, a plump rodent body, a thin hairless ropey tail, NOT a bushy tail:1.4), matted brown and rust-grey fur with clearly visible individual fur tufts, glowing red eyes, sharp yellowed incisors bared, crouched low and hunched on all fours like vermin, well-lit dim dungeon corridor with enough ambient light to see the creature clearly",
    "Mangy Hyena": "(Solo Leveling manhwa cel-shaded anime art style, bold black ink outlines, flat cel shading with hard shadow edges, NOT a realistic painterly or photographic render:1.4), a feral HYENA, (tawny tan and dirty-cream fur covered in dark brown spots and patches, clearly visible mottled coloring, explicitly NOT a solid black or near-black shape:1.3), patchy mangy fur missing in scarred clumps, a powerful jaw with bared yellowed teeth, glowing amber eyes, a hunched sloped back with powerful front shoulders, low aggressive stalking stance on all fours, dusty cracked-earth wasteland background in clear daylight",
    "Goblin": "a small wiry GOBLIN humanoid, (bright sickly green mottled skin, green must be the clearly visible dominant skin color, not black or dark grey:1.4), oversized pointed ears, a hooked nose, sharp yellowed teeth bared in a snarl, ragged dark leather scraps for clothing, gripping a crude rusted blade, crouched scrappy stance, beady yellow eyes, well-lit gritty dungeon background with the creature's green skin tone clearly visible",
    "Bandit": "a rough human BANDIT, (a plainly visible weathered human face with stubble, narrowed eyes, and visible tan skin — explicitly NOT a hooded faceless reaper, wraith, or undead figure:1.3), a simple worn leather jerkin and a loose neck scarf, no large hood or flowing death-cloak, gripping a plain worn dagger, alert scrappy stance, dim alley background, a mundane lowlife criminal, not an elite or supernatural figure",
    "Wolf": "a lean WOLF, (dense layered fur in natural grey and white tones with clearly visible individual fur strands — the fur must read as grey/white, not solid black or a silhouette:1.3), sharp pointed ears alert and forward, bared fangs in a snarl, glowing pale yellow eyes, muscular low predatory stance on all fours, bushy tail held low, well-lit snowy forest background",
    "Dire Wolf": "an enormous wolf-like beast, far larger and more savage than an ordinary wolf, standing in a bright golden-lit clearing in full daylight, lit directly from the front with no shadow or silhouette, (dense shaggy fur in ash-grey and steel-grey tones clearly visible in the sunlight, explicitly NOT a solid black or near-black shape:1.4), a scarred muzzle, oversized fangs bared, glowing amber eyes, thick powerful shoulders, low aggressive stance on all fours",
    "Orc": "a hulking ORC warrior, (Solo Leveling manhwa cel-shaded anime art style with bold black ink outlines, explicitly NOT realistic painterly rendering:1.3), (thick green-grey mottled skin with visible scarring, green must be clearly visible as the dominant skin tone:1.3), a jutting lower jaw with prominent tusks, small dark eyes under a heavy brow, crude spiked iron armor plates strapped over leather, gripping a heavy cleaver-like blade, broad aggressive stance, war-camp background",
    "Ogre": "a massive lumbering OGRE, (Solo Leveling manhwa cel-shaded anime art style with bold black ink outlines, explicitly NOT realistic painterly rendering:1.3), (thick warty greenish-brown skin with deep folds, green must be clearly visible:1.3), a heavy brutish jaw with jutting yellowed tusks, small dull eyes under a heavy brow, a bloated muscular frame wrapped in crude furs and rusted armor scraps, gripping a crude wooden club studded with nails, hunched towering menacing stance",
    ...
    "Harpy": "a HARPY, a winged humanoid with a feral feathered upper body, (mottled brown and rust-orange feathers with clearly visible individual feather texture along muscular wings and arms — feathers must read as brown/rust, not solid black or a silhouette:1.3), sharp taloned bird-like feet, a sharp-featured face with wild hair and glowing pale eyes, hooked claws extended, captured mid-swoop with wings flared, well-lit cliffside background with the plumage clearly visible, no text or symbols or letters anywhere in the image",
